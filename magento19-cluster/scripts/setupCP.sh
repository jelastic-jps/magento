...
wget https://raw.githubusercontent.com/jelastic-jps/magento/master/magento19-cluster/configs/sites-enables/default.conf -O /etc/nginx/sites-enabled/default.conf;
